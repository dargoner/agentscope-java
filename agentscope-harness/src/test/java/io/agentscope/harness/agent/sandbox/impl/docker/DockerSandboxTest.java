...
class DockerSandboxTest {
    ...
    @Test
    void getWorkspaceRoot_delegatesToWorkspaceSpec() {
        DockerSandboxState state = new DockerSandboxState();
        WorkspaceSpec spec = new WorkspaceSpec();
        spec.setRoot("/custom/workspace");
        state.setWorkspaceSpec(spec);

        DockerSandbox sandbox = new DockerSandbox(state);
        assertEquals("/custom/workspace", sandbox.getWorkspaceRoot());
    }

    @Test
    void getWorkspaceRoot_defaultWorkspaceSpec() {
        DockerSandboxState state = new DockerSandboxState();
